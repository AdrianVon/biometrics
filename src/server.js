...
const redirect = `https://api.prod.whoop.com/oauth/oauth2/auth?client_id=${process.env.WHOOP_CLIENT_ID}&redirect_uri=${process.env.WHOOP_REDIRECT_URI}&response_type=code&scope=read:recovery`;
});
